...
if __name__ == '__main__':
    # init data
    datfile = 'HDL32_01_2018Y08M08D18H18m14s'
    lidar = cLidarFrame(self.settings, datfile, '\\LIDAR')
    ...
    # # RADAR
    # radar = cRadarFrame(self.settings, datfile, '\\FrontRadar')
                
    # # Object        
    # Object = cObjectDB(self.settings, datfile)
